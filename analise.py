...
def mostrar():
    ...
    with abas[0]:
        ...
        **Período Analisado**
        ...
        # Carregar o SVG
        with open("D:/Tech 4/imagens/1.svg", "r", encoding="utf-8") as f:
            svg_content = f.read()
    ...
    with abas[1]:
        ...
        * A **análise bivariada** revelou uma correlação positiva (0.74) entre o volume e o ano, indicando que o volume de negociações vem aumentando de forma consistente ao longo do tempo. Por outro lado, a correlação negativa entre fechamento e ano (-0.27) evidencia uma leve tendência de queda nos preços de fechamento do Brent.
        ...
        # Carregar o SVG
        with open("D:/Tech 4/imagens/2.svg", "r", encoding="utf-8") as f:
            svg_content = f.read()
        ...
        # Carregar o SVG
        with open("D:/Tech 4/imagens/3.svg", "r", encoding="utf-8") as f:
            svg_content = f.read()
        # Exibir o SVG de forma responsiva
        st.markdown(f"""
            <div style="width: 100%; height: auto; min-width: 200px; min-height: 200px; display: flex; justify-content: left;">
       ...
       #2.2
        ...
        with st.expander("Saiba mais."):
            ...
            """)
            # Carregar o SVG
            with open("D:/Tech 4/imagens/4.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
        ...
        with st.expander("Saiba mais."):
            ...
            """)
            # Carregar o SVG
            with open("D:/Tech 4/imagens/5.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
        ...
        with st.expander("Saiba mais."):
            ...
            """)
            # Carregar o SVG
            with open("D:/Tech 4/imagens/6.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
            ...
            # Carregar o SVG
            with open("D:/Tech 4/imagens/7.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
    ...
    with abas[2]:
        ...
        # Carregar o SVG
        with open("D:/Tech 4/imagens/8.svg", "r", encoding="utf-8") as f:
            svg_content = f.read()
        ...
        # Carregar o SVG
        with open("D:/Tech 4/imagens/9.svg", "r", encoding="utf-8") as f:
            svg_content = f.read()
        # Exibir o SVG de forma responsiva
        st.markdown(f"""
            <div style="width: 100%; height: auto; min-width: 200px; min-height: 200px; display: flex; justify-content: left;">
        ...
        with st.expander("Saiba mais"):
            ...
            """)
            # Carregar o SVG
            with open("D:/Tech 4/imagens/10.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
            ...
            # Carregar o SVG
            with open("D:/Tech 4/imagens/11.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
            # Exibir o SVG de forma responsiva
            st.markdown(f"""
                <div style="width: 100%; height: auto; min-width: 200px; min-height: 200px; display: flex; justify-content: left;">
            ...
            """, unsafe_allow_html=True)
            # Carregar o SVG
            with open("D:/Tech 4/imagens/12.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
            # Exibir o SVG de forma responsiva
            st.markdown(f"""
                <div style="width: 100%; height: auto; min-width: 200px; min-height: 200px; display: flex; justify-content: left;">
        ...
        with st.expander("Saiba mais"):
            ...
            * **730 dias (2 anos):** Mostra ciclos de alta seguidos por períodos prolongados de estabilização ou queda. Indica movimentos estruturais do mercado, como choques de oferta, crises econômicas e mudanças na geopolítica do petróleo.""")
            # Carregar o SVG
            with open("D:/Tech 4/imagens/13.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
        ...
        with st.expander("Saiba mais"):
            ...
            # Carregar o SVG
            with open("D:/Tech 4/imagens/14.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
        ...
        **Resultado:** Ao final do estudo foi observado que a série temporal do Brent revelou um ACF alto/persistente (227 lag) e PACF com corte rápido (2), o que é característico de séries com forte componente autorregressiva, possivelmente integradas. É comum em séries de preços financeiros e sugere que, embora a história distante importe para o comportamento geral da série, para fins de previsão imediata, é necessário considerar os dois dias anteriores.
        ...
        with st.expander("Saiba mais"):
            ...
            """)
            # Carregar o SVG
            with open("D:/Tech 4/imagens/15.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
        ...
        with st.expander("Saiba mais"): 
            ...
            # Carregar o SVG
            with open("D:/Tech 4/imagens/16.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
        ...
        with st.expander("Saiba mais"):
            st.code("""
                ...
                """, language="python")    
            # Carregar o SVG
            with open("D:/Tech 4/imagens/17.svg", "r", encoding="utf-8") as f:
                svg_content = f.read()
